...
import { get_absolute_coord } from './helper.js'
...
export class Dropdown {
  ...
  gen_dropdown(default_text) {
    ...
    this.dropdown.style.borderBottom = 'solid 0.5px #777777'
    ...
    this.dropdown_text.innerText = default_text.replace(/-/g, ' ').replace(/_/g, ' ')
    // this.dropdown_contents.appendChild(this.dropdown_text)
  ...
  gen_dropdown_menu() {
    ...
    this.dropdown_menu.style.background = 'white'
    this.dropdown_menu.style.transform = 'translate(0px, 5px)'
    this.dropdown_menu.style.border= '1px solid gray'
    this.dropdown_menu.style.borderRadius = '5px'
    this.dropdown_menu.style.padding = '10px'
